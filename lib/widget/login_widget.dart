...
Widget loginWidget(
    CountryCode countryCodes, Function onCountryChange, Function onSubmit) {
  return Padding(
      ...
      child: Column(
        ...
        children: [
          textWidget(
              text: AppConstant.bonjourRavis, fontWeight: FontWeight.w400),
          const SizedBox(
            height: 20,
          ),
          textWidget(
              text: AppConstant.pretPartir,
              fontSize: 20,
            ...
            child: RichText(
                ...
                text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                          text: AppConstant.conditionUtilisation,
                          style:
                              GoogleFonts.poppins(fontWeight: FontWeight.bold)),
                      const TextSpan(text: " et nos "),
                      TextSpan(
                          text: AppConstant.politiqueConfidentialite,
                          style:
                              GoogleFonts.poppins(fontWeight: FontWeight.bold)),
                    ])),
          )
